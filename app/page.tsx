  ...
  return (
    <section>
      ...
      <p className="mb-8 leading-relaxed">
        ...
        <a href="https://www.sixtyfour.ai" className="text-orange-400"> Sixtyfour (YC X25)</a>, where we build infrastructure for deploying research agents that gather verified, evidence-backed intelligence on people and companies.
      </p>
      <p className="mb-8 leading-relaxed">
      ...
      <p className="mb-8 leading-relaxed">
        In summer 2023, I joined Deepgram (YC W16), where I built full-stack tools around live event transcription and sentiment analysis around Youtube videos. After that, my friend Eric and I built a Shopify chatbot at Internalize that combined LLMs with recommendation engines.
      </p>
      <p className="mb-8 leading-relaxed">
